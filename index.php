...
<html lang="en">
    ...
    <style>
        ...
        .navbar-brand .logo-img {
            ...
            margin-right: 20px; /* Space between logo and website name */
            vertical-align: left; /* Aligns logo with text */
        }
    </style>
    <body id="page-top">
        <!-- Navigation-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">
                    <img src="admin/assets/uploads/logo.png" alt="Logo" class="logo-img">
        ...
        <footer class="py-5">
            ...
            <br>
            <div class="container">
                <div class="small text-center text-muted">Copyright © 2024 - Department of Computer Science - Pondicherry University | <a href="https://www.pondiuni.edu.in/department/department-of-computer-science/" target="_blank">DoCSPU</a></div>
            </div>
        </footer>
